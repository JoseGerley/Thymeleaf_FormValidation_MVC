...
public class ThymeleafValidationApplication {
	...
	public static void main(String[] args) {
		...
		User user1 = new User();
		user1.setUsername("jc01");
		user1.setName("Juan");
		user1.setEmail("jc@gmail.com");
		user1.setType(UserType.doctor);
		user1.setBirthDate(LocalDate.of(2001, 4, 17));
		user1.setGender(UserGender.masculine);
		user1.setPassword("JoseGer2001");
		u.save(user1);
		User user2 = new User();
		user2.setUsername("anie");
		user2.setName("Ana");
		user2.setEmail("ana@gmail.com");
		user2.setType(UserType.patient);
		user2.setBirthDate(LocalDate.of(1991,12,22));
		user2.setGender(UserGender.femenine);
		user2.setPassword("JoseMorales0417");
		u.save(user2);
	}
